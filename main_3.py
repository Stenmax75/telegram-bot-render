...
# Получаем DSN для Redis из переменной окружения
REDIS_DSN = os.getenv("REDIS_DSN")

if REDIS_DSN:
    # Пытаемся использовать RedisStorage
    try:
